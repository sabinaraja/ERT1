...
expName = 'ERT1'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sabina/Desktop/IN-PERSON STUDY/ERT1/ERT1_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "ecg_instructions" ---
    text_9 = visual.TextStim(win=win, name='text_9',
        text='The experiment begins with recording your ECG activity.\n\nPlease do not move or speak during this time. Keep your feet flat on the ground, and keep your hands in your lap. If you have any questions for your experimenter, ask now.\n\nThe recording will take 5 minutes, and the task will progress on its own once the 5 minutes are up.\n\nWhen you are ready to proceed, hit any key to continue.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text = visual.TextStim(win=win, name='text',
        text='Your baseline ECG recording has been recorded. You will now progress to the next part of the task. \n\nHit any key to continue. ',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_7 = visual.TextStim(win=win, name='text_7',
        text='0 \n(Not at all \ntrustworthy)',
        font='Open Sans',
        pos=(-0.6, -0.4), height=0.02, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    ...
    text_6 = visual.TextStim(win=win, name='text_6',
        text='Thank you for completing this task!\n\nYou can now tell your experimenter you have completed the task. Press any key to terminate this window. ',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Prepare to start Routine "ecg_instructions" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('ecg_instructions.started', globalClock.getTime())
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    ecg_instructionsComponents = [text_9, key_resp_4]
    for thisComponent in ecg_instructionsComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "ecg_instructions" ---
    for thisComponent in ecg_instructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('ecg_instructions.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "ecg_instructions" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    # --- Prepare to start Routine "ecg_baseline" ---
    continueRoutine = True
    # update component parameters for each repeat
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    InstructionsComponents = [text_2, mouse, key_resp]
    ...
    for thisPractice in Practice:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('fixationcross2.started', globalClock.getTime())
        # keep track of which components have finished
        fixationcross2Components = [fixation]
        for thisComponent in fixationcross2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        for thisComponent in fixationcross2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('fixationcross2.stopped', globalClock.getTime())
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('practicefaces_2.started', globalClock.getTime())
        practicefaces.setImage(Practice_Faces)
        # keep track of which components have finished
        practicefaces_2Components = [practicefaces]
        for thisComponent in practicefaces_2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        for thisComponent in practicefaces_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('practicefaces_2.stopped', globalClock.getTime())
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Trustworthiness_Rating.started', globalClock.getTime())
        slider.reset()
        # keep track of which components have finished
        Trustworthiness_RatingComponents = [slider, text_3, text_7, text_8]
        for thisComponent in Trustworthiness_RatingComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "Trustworthiness_Rating" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
        ...
        for thisComponent in Trustworthiness_RatingComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Trustworthiness_Rating.stopped', globalClock.getTime())
    ...
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    Instructions_2Components = [text_5, key_resp_3]
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Face_Stimuli.xlsx'),
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('TrialFaces.started', globalClock.getTime())
        FaceStimuli.setImage(Face_Stimuli)
        # keep track of which components have finished
        TrialFacesComponents = [FaceStimuli]
        for thisComponent in TrialFacesComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine and routineTimer.getTime() < 0.3:
            ...
            # if FaceStimuli is starting this frame...
            if FaceStimuli.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                FaceStimuli.frameNStart = frameN  # exact frame index
                FaceStimuli.tStart = t  # local t and not account for scr refresh
                FaceStimuli.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(FaceStimuli, 'tStartRefresh')  # time at next scr refresh
                # update status
                FaceStimuli.status = STARTED
                FaceStimuli.setAutoDraw(True)
            
            # if FaceStimuli is active this frame...
            if FaceStimuli.status == STARTED:
                # update params
                pass
            
            # if FaceStimuli is stopping this frame...
            if FaceStimuli.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > FaceStimuli.tStartRefresh + 0.3-frameTolerance:
                    # keep track of stop time/frame for later
                    FaceStimuli.tStop = t  # not accounting for scr refresh
                    FaceStimuli.frameNStop = frameN  # exact frame index
                    # update status
                    FaceStimuli.status = FINISHED
        ...
        for thisComponent in TrialFacesComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('TrialFaces.stopped', globalClock.getTime())
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    End_MessageComponents = [text_6, key_resp_2]
